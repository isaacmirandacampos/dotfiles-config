# Generated by Powerlevel10k configuration wizard on 2024-04-03 at 21:47 -03.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=31
  ...
  typeset -g POWERLEVEL9K_DIR_MAX_LENGTH=90
  ...
  typeset -g POWERLEVEL9K_NORDVPN_FOREGROUND=214
  typeset -g POWERLEVEL9K_NORDVPN_BACKGROUND=31
  ...
  typeset -g POWERLEVEL9K_RVM_BACKGROUND=31
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=202
