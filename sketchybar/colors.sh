...
# Solarized Osaka
export BLACK=0xFF000a0d
export WHITE=0xFFfef9e2
export RED=0xFFe34b46
export GREEN=0xFF849900
export BLUE=0xFF2784d2
export YELLOW=0xFFb39500
export ORANGE=0xFFcb6916
export MAGENTA=0xFFd93091
export CYAN=0xFF2aa395
export VIOLET=0xFF6f67c7
export GREY=0xFF848e91
export BG0=0xFF000a0d
export BG1=0x6000161c
export BG2=0x6007242b
