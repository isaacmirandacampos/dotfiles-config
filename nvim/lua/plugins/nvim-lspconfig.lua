-- ~/.config/neovim/neobean/lua/plugins/nvim-lspconfig.lua
-- Filename: ~/.config/neovim/neobean/lua/plugins/nvim-lspconfig.lua
--
...
return {
  ...
  opts = {
    ...
    servers = {
      ...
      -- ~/.config/neovim/neobean/lua/config/autocmds.lua
      harper_ls = {
        enabled = true,
        filetypes = { "markdown" },
        settings = {
          ["harper-ls"] = {
            userDictPath = "~/.config/neovim/neobean/spell/en.utf-8.add",
            linters = {
              ToDoHyphen = false,
